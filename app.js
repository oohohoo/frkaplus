...
function initScroll(container) {
  ...
  locoScroll = new LocomotiveScroll({
    ...
    offset: [0, 0],
    getDirection: true,
    scrollbarContainer: document.querySelector('.xxxfake-scrollbar'),
...
style: 'mapbox://styles/fogseller/ckpwnx90j06ed17pfbvqeg6lj?optimize=true', // style URL / dodano optimize=true
...
var Demo = function (element) {
	...
	this.categories = Array.from(document.querySelectorAll('.js-categories .listitem .link_container .linkos .botun button'));
  this.message = document.querySelector('.js-message');
