...
function lokacijehover() {
  ...
  gsap.utils.toArray(".webinar-posts__event-link").forEach(container => {
        let lokacija = container.querySelector(".webinar-posts__event-item img"),
           changecolor = container.querySelector(".webinar-posts__event-item"), 
          tl = gsap.timeline({
            paused: true
          });
...
setTimeout(function () { 
  ...
  pond.addEventListener('FilePond:processfile', function (e, file) {
      ...
      img_cropping.cropper({
          viewMode: 3,
          dragMode: 'move',
          aspectRatio: <?php echo get_field( 'mob-width' ); ?>/<?php echo get_field( 'mob-height' ); ?>, 
          guides: false,
         /*  modal: true,
          highlight: true, */
      ...
      $('#crop_img').on('click', function (ev) {
         ...
         //    console.log("02 crop slide down");
          ...
          cropped_img = img_cropping.cropper('getCroppedCanvas', {
              ...
              width: <?php echo get_field( 'mob-width' ); ?>,
              height: <?php echo get_field( 'mob-height' ); ?>,
  ...
  pond.addEventListener('FilePond:removefile', function (e) {
   ...
   $('.movevideo').click(function(){
    $('video').addClass('<?php if( get_field('video-ver') ): ?> <?php echo 'vert'; ?><?php endif; ?> <?php if( get_field('video-hor') ): ?> <?php echo 'hor'; ?><?php endif; ?>');
      console.log("MOVE VIDEO CLICK AND ADD CLASS");
  });
