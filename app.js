...
$('.turnonpdf').click(function() {
  ...
  // Hide PDF Button
$('.filepond--file .filepond--processing-complete-indicator, .filepond--file .filepond--progress-indicator, .filepond--file .filepond--file-action-button').click(function() {
/*   setTimeout(()=>{ */
  $('.butonio').toggleClass('hide');
