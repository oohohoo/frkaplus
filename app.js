...
const roll1 = roll(".roll1", {duration: 40}, true), // ugasi true i mijenja smjer
      roll2 = roll(".roll2", {duration: 60}),
      roll3 = roll(".roll3", {duration: 20}, true),
      roll4 = roll(".roll4", {duration: 30}),
      roll5 = roll(".roll5", {duration: 80}, true);
